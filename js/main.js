document.addEventListener("DOMContentLoaded", function() {
    ...
    const signos =[
        {signo: "Aries", imagen: "./imgs/velociraptor.jpg", texto: `
            ...
            `},
        {signo: "Tauro", imagen: "./imgs/triceratops.jpg", texto: `
            ...
            `},
        {signo: "Géminis", imagen: "./imgs/archaeopteryx.jpg", texto: `
            ...
            `},
        {signo: "Cáncer", imagen: "./imgs/maiasaura.jpg", texto: `
            ...
            `},
        {signo: "Leo", imagen: "./imgs/tyrannosaurus.jpg", texto: `
            ...
            `},
        {signo: "Virgo", imagen: "./imgs/microraptor.jpg", texto: `
            ...
            `},
        {signo: "Libra", imagen: "./imgs/diplodocus.jpg", texto: `
            ...
            `},
        {signo: "Escorpio", imagen: "./imgs/dilophosaurus.jpg", texto:  `
    ...
    signos.forEach(signo => {
        ...
        option.textContent = signo.signo;
        signoSelect.appendChild(option);
    });
    ...
    signoSelect.addEventListener("change", function() {
        ...
        signos.filter(signo => {
            if(signo.signo === signoSeleccionado){
                texto = signo.texto;
                imagenURL = signo.imagen;
            }
        })
